...
var FakeDatabase = function () {
    function FakeDatabase() {
        ...
        this.authors = [{ id: '88dbec2', name: 'Xavier First', email: 'xavier@fakeemail.com' }, { id: '77e2448a', name: 'Jesse Baker', email: 'Jesse@fakeemail.com' }, { id: '0beb564c', name: 'Adam Richards', email: 'Adam@fakeemail.com' }], this.blogPosts = [{
            id: 1,
            ...
            author: '77e2448a'
        }], this.comments = [{ id: '1', postId: 1, name: 'Anonymous First', content: 'Good luck with your blog!' }, { id: '2', postId: 2, name: 'Nick Second', content: 'Great first article. Do you have another?' }, { id: '3', postId: 3, name: 'Peter Third', content: 'You should check out GraphQL!' }];
    }
